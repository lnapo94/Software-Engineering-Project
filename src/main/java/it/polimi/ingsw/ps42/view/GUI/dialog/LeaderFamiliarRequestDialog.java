...
/**
 * Class for familiar request generated by a leader card
 * 
...
public class LeaderFamiliarRequestDialog extends JDialog{
	...
	/**
	 * Constructor of the window given the GUIView where it will be displayed
	 * 
	 * @param view the GUIView where the window will be displayed
	 * @param message the familiar request message
	 */
	...
	/**
	 * Method to enable the window to be visible and usable
	 */
	public void run() {
		this.pack();
	...
	/**
	 * Private method to send the choice made to the view
	 */
	...
	/**
	 * Private class to handle selection events
	 * 
	 * @author Luca Napoletano, Claudio Montanari
	 *
	 */
	private class ConfirmAction implements ActionListener {
		...
		/**
		 * When activated send to the view the choice made
		 */
		@Override
