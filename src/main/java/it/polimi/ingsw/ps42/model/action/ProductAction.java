...
public class ProductAction extends Action {
	...
	public ProductAction(ActionType type, Familiar familiar, List<Position> tablePosition, int positionInTableList){
		//Constructor for normal action
		super(type, familiar, tablePosition, positionInTableList);
	}
	
	public ProductAction(ActionType type, Player player, List<Position> tablePosition, int positionInTableList){
